...
public class InvoiceTest {
    ...
    public void testDeserialization() throws Exception {
        ...
        File file = new File("/Users/berrysa/projects/stackoverflow/src/main/java/com/samlikescode/stackoverflow/questions/q30167770/externalAPIResponse.xml");

        Invoice invoice = xmlMapper.readValue(file, Invoice.class);

        assertEquals(new Double(10.42), invoice.getMoney().getCost());
        assertEquals("USD", invoice.getMoney().getCurrency());
    }
}
