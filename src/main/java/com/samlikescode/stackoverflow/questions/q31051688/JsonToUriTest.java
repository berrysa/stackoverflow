...
*/
package com.samlikescode.stackoverflow.questions.q31051688;
...
public class JsonToUriTest {
    ...
    private final static String desiredUri = "http://api.statdns.com/google.com/cname";

    @Test
    public void testJsonToUri() throws IOException {
    ...
    private void initiateRESTCall(String uri) {
