...
*/
package com.samlikescode.stackoverflow.questions.q31059325;
...
public class JsonTemplatingTest {
    ...
    private final static String firstJson = "{\"sentence\" : \"{{place_name}} is {{adj}} place\"}";
    private final static String secondJson = "{\"place_name\" : \"New York\", \"adj\" : \"a nice\"}";

    private static final ObjectMapper om = new ObjectMapper();

    @Test
    public void testTemplating() throws IOException {
        JsonNode secondJsonNode = om.readTree(secondJson);
