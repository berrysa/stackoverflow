...
*/
package com.samlikescode.sandbox.jackson.mixin;
 ...
 * //todo(sb)
 */
public class FaceToEyesConverter extends StdConverter<Face, Eyes> {

    @Override
    public Eyes convert(Face face) {
        return new Eyes(face.getEyes());
    }
}
